...
<html lang="en">
    ...
    <head>
        ...
        <title>OmniView: Transactions Page</title>
        ...
        <div class="container-fluid">
                    ...
                    <table class="table table-striped" id="transactionTable">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $query = "SELECT * FROM transaction_list LIMIT $offset, $records_per_page";
            ...
            <div class="text-center">
                <?php
                    ...
                    $count_query = "SELECT COUNT(*) AS total_records FROM transaction_list";
                    ...
                    for ($i = 1; $i <= $total_pages; $i++) {
                        echo "<a href='transaction.php?page=$i' class='btn btn-primary'>$i</a> ";
                    }
                ?>
            </div>
        </div>
