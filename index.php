            ...
            <nav class="navbar navbar-expand-lg bg-light text-center px-4 ">
              ...
              <div class="container">
                <div class="row px-2">
                      ...
                      <div class="carousel-inner">
                         <div class="carousel-item active">
                          ...
                          <div class="nav-bar-page">                    
                            ...
                            <h5><button id="btn4"><a href="contact.php">Consult our Specialist now!</a></button></h5>
                        </div>
                        </div>
                  ...
                  <div class="col-sm-12 col-md-6 col-lg-6 col-12">
                    <img src="ASSETS/index-img/img01.jpg" alt="" class="img-fluid rounded-end">
                  </div>
                </div>
              </div>
        </header>
                ...
                <div class="container">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 col-12">
                      <img src="ASSETS/index-img/img05.jpeg" alt="" class="img-fluid p-8">
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section id="manage" class="p-4">
                <div class="container">
                  <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-12">
                      <img src="ASSETS/index-img/img04.jpg" alt="" class="img-fluid rounded-end">
                    </div>
              ...
              <section id="services" class="p-4 my-5">
                <div class="text-center mb-5">
                  <img src="ASSETS/index-img/icon-2.png" alt="" class="img-fluid rounded-end" width="150px" height="150px">
                  <h2>What we Do!</h2>
                  <hr class="w-25 m-auto">
                </div>
                <div class="container">
              ...
              <section id="news" class="my-5 p-4">
                <div class="text-center mb-5">
                  <img src="ASSETS/index-img/news.png" alt="" class="img-fluid" width="50px" height="50px">
                  <h2>Latest News !</h2>
                  <hr class="w-25 m-auto">
                </div>
                <div class="container">
                  <div class="row mb-5">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-12">
                      <img src="ASSETS/index-img/img03.jpg" alt="" class="img-fluid img-thumbnail rounded-pill">
                    </div>
                  ...
                  <div class="row mt-5">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-12">
                      <img src="ASSETS/index-img/img02.webp" alt="" class="img-fluid img-thumbnail">
                    </div>
                  </div>   
                </div>
              </section>
