...
<html lang="en">
    ...
    <head>
        ...
        <title>OmniView: Suppliers Page</title>
        ...
        <div class="container-fluid">
                    ...
                    <table class="table table-striped" id="supplierTable">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $query = "SELECT * FROM supplier_list LIMIT $offset, $records_per_page";
            ...
            <div class="text-center">
	            <?php
		            ...
		            $count_query = "SELECT COUNT(*) AS total_records FROM supplier_list";
		            ...
		            for ($i = 1; $i <= $total_pages; $i++) {
			            echo "<a href='supplier.php?page=$i' class='btn btn-primary'>$i</a> ";
		            }
	            ?>
            </div>
        </div>
