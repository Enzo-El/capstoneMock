...
<html lang="en">
    ...
    <head>
        ...
        <title>OmniView: Customers Page</title>
        ...
        <div class="container-fluid">
                    ...
                    <table class="table table-striped" id="customerTable">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $query = "SELECT * FROM customer LIMIT $offset, $records_per_page";
            ...
            <div class="text-center">
	            <?php
		            ...
		            $count_query = "SELECT COUNT(*) AS total_records FROM customer";
		            ...
		            for ($i = 1; $i <= $total_pages; $i++) {
			            echo "<a href='customer.php?page=$i' class='btn btn-primary'>$i</a> ";
		            }
	            ?>
            </div>
        </div>
